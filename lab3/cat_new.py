...
def cat(x0, y0, size):
    ...
    """Nose"""
    graph.polygon([(x0 - 220 * size, y0 + 10 * size), (x0 - 240 * size, y0 + 10 * size), (x0 - 230 * size, y0 + 20 * size)])
    graph.penSize(2)
    graph.penColor("black")
    graph.line(x0 - 230 * size, y0 + 20 * size, x0 - 230 * size, y0 + 40 * size)
    graph.polyline([(x0 - 230 * size, y0 + 40 * size), (x0 - 229 * size, y0 + 41 * size), (x0 - 229 * size, y0 + 42 * size),
    ...
    graph.polyline([(x0 - 230 * size, y0 + 40 * size), (x0 - 231 * size, y0 + 41 * size), (x0 - 231 * size, y0 + 42 * size),
...
graph.polyline([(84, 726), (81, 722), (77, 718), (62, 715), (53, 715), (42, 716), (36, 719), (30, 723), (26, 727), (22, 730),
          (21, 734)])
...
# lines on hairball
graph.brushColor("black")
graph.polyline([(459, 876), (469, 876), (481, 879), (488, 882), (493, 890), (494, 895), (503, 904), (504, 907), (511, 915),
          (514, 917), (521, 920), (522, 919)])
graph.polyline([(462, 892), (466, 893), (475, 899), (483, 906), (485, 909), (489, 928), (490, 929), (497, 933), (503, 935),
          (505, 937), (525, 942)])
graph.polyline([(430, 885), (438, 885), (442, 889), (445, 892), (448, 899), (453, 908), (455, 913), (460, 925), (464, 935),
          (474, 939), (476, 940), (484, 945), (491, 947), (506, 949), (511, 949), (518, 947)])
graph.polyline([(426, 916), (431, 920), (446, 928), (456, 939), (462, 953), (462, 958), (463, 965), (463, 965), (465, 976)])
graph.polyline([(475, 966), (487, 969), (494, 964), (500, 958)])
graph.penSize(2)
graph.polyline([(199, 974), (203, 970), (213, 954), (226, 939), (239, 935), (294, 931), (308, 936), (315, 942), (325, 950),
